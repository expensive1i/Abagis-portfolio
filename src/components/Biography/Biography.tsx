            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-stretch relative">
              ...
              <div className="space-y-4 text-white h-full">
                <div className="space-y-3">
                  ...
                  <div className="space-y-3">
                    <p className={`text-base lg:text-lg leading-relaxed text-justify text-white/95 transition-all duration-1000 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '1.0s' }}>
                    ...
                    <p className={`text-base lg:text-lg leading-relaxed text-justify text-white/95 transition-all duration-1000 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '1.2s' }}>
              ...
              <div className="space-y-4 text-white h-full">
                <div className="space-y-3">
                  ...
                  <p className={`text-base lg:text-lg leading-relaxed text-justify text-white/95 transition-all duration-1000 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '1.8s' }}>
                ...
                <div className="space-y-3">
                  ...
                  <p className={`text-base lg:text-lg leading-relaxed text-white/95 transition-all duration-1000 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '2.2s' }}>
