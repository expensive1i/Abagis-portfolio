        ...
        <div className="max-w-7xl mx-auto pattern-bg">
          ...
          <div className={`text-left mb-8 sm:mb-10 lg:mb-12 transition-all duration-500 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '0.1s' }}>
            <div className={`inline-flex items-center gap-2 sm:gap-3 mb-4 sm:mb-6 transition-all duration-500 ease-out ${isVisible ? 'opacity-100 scale-100' : 'opacity-0 scale-75'}`} style={{ transitionDelay: '0.2s' }}>
              ...
              <span className="text-[#023F33] font-semibold tracking-widest uppercase text-xs sm:text-sm" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>Lifestyle</span>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-12 items-start">
            ...
            <div className={`lg:col-span-1 relative overflow-hidden transition-all duration-500 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '0.5s' }}>
              {/* Portrait Image */}
              <div 
                className="w-full h-full min-h-[400px] sm:min-h-[500px] lg:min-h-[550px] rounded-2xl sm:rounded-3xl overflow-hidden shadow-lg"
                style={{
              ...
              >
                ...
                <div className="absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black/90 via-black/70 to-transparent h-32 sm:h-40 lg:h-48 rounded-b-2xl sm:rounded-b-3xl"></div>
                
                {/* Integrity in Innovation Text */}
                <div className="absolute bottom-0 left-0 right-0 p-4 sm:p-6 lg:p-8 text-white rounded-b-2xl sm:rounded-b-3xl">
            ...
            <div className="lg:col-span-2 flex flex-col h-full">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                  ...
                  <div className={`group transition-all duration-500 transform hover:-translate-y-2 transition-all duration-500 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '0.6s' }}>
                    <div className="flex items-start gap-3 sm:gap-4 mb-3">
                      <div className="w-12 h-12 sm:w-16 sm:h-16 bg-[#023F33]/10 rounded-full flex items-center justify-center group-hover:scale-110 transition-transform duration-300 flex-shrink-0">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-6 h-6 sm:w-8 sm:h-8 text-[#023F33]">
                      ...
                      <div>
                        <h3 className="text-base sm:text-lg font-bold text-[#023F33] leading-tight mb-2" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>Fundraising Extraordinaire</h3>
                  ...
                  <div className={`group transition-all duration-500 transform hover:-translate-y-2 transition-all duration-500 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '0.7s' }}>
                    <div className="flex items-start gap-3 sm:gap-4 mb-3">
                      ...
                      <div>
                        <h3 className="text-base sm:text-lg font-bold text-[#023F33] leading-tight mb-2" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>Empowerment Through Mentorship</h3>
                        <p className="text-gray-700 leading-relaxed text-xs sm:text-sm text-justify">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
                  ...
                  <div className={`group transition-all duration-500 transform hover:-translate-y-2 transition-all duration-500 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '0.8s' }}>
                    <div className="flex items-start gap-3 sm:gap-4 mb-3">
                      ...
                      <div>
                        <h3 className="text-base sm:text-lg font-bold text-[#023F33] leading-tight mb-2" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>Leadership Rooted in Purpose</h3>
                        <p className="text-gray-700 leading-relaxed text-xs sm:text-sm text-justify">
                  ...
                  <div className={`group transition-all duration-500 transform hover:-translate-y-2 transition-all duration-500 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '0.9s' }}>
                    <div className="flex items-start gap-3 sm:gap-4 mb-3">
                      ...
                      <div>
                        <h3 className="text-base sm:text-lg font-bold text-[#023F33] leading-tight mb-2" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>Champion for Women & Education</h3>
                        <p className="text-gray-700 leading-relaxed text-xs sm:text-sm text-justify">
              ...
              <div className={`bg-white rounded-2xl sm:rounded-3xl p-4 sm:p-6 mt-4 transition-all duration-500 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '1.0s' }}>
                <div className="text-left mb-4 sm:mb-6">
                  <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-[#023F33] mb-3 sm:mb-4" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>Beyond the Boardroom</h3>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 lg:gap-5">
                  {/* Interest 1 */}
                  <div className={`flex items-center gap-2 sm:gap-3 transition-all duration-500 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '1.1s' }}>
                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-[#023F33] rounded-full flex items-center justify-center flex-shrink-0">
                      <svg className="w-3 h-3 sm:w-4 sm:h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                      </svg>
                    </div>
                    <div>
                      <h4 className="font-semibold text-[#023F33] mb-1 text-sm sm:text-base" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>Reading</h4>
                      <p className="text-xs sm:text-sm text-gray-600">Leadership, governance, and African literature</p>
                    </div>
                  </div>

                  {/* Interest 2 */}
                  <div className={`flex items-center gap-2 sm:gap-3 transition-all duration-500 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '1.2s' }}>
                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-[#023F33] rounded-full flex items-center justify-center flex-shrink-0">
                      <svg className="w-3 h-3 sm:w-4 sm:h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                      </svg>
                    ...
                    <div>
                      <h4 className="font-semibold text-[#023F33] mb-1 text-sm sm:text-base" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>Travel</h4>
                      <p className="text-xs sm:text-sm text-gray-600">Exploring African communities and cultures</p>
                    </div>
                  </div>

                  {/* Interest 3 */}
                  <div className={`flex items-center gap-2 sm:gap-3 transition-all duration-500 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '1.3s' }}>
                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-[#023F33] rounded-full flex items-center justify-center flex-shrink-0">
                      <svg className="w-3 h-3 sm:w-4 sm:h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                      </svg>
                    ...
                    <div>
                      <h4 className="font-semibold text-[#023F33] mb-1 text-sm sm:text-base" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>Networking</h4>
                      <p className="text-xs sm:text-sm text-gray-600">Building strategic partnerships</p>
                    </div>
                  </div>

                  {/* Interest 4 */}
                  <div className={`flex items-center gap-2 sm:gap-3 transition-all duration-500 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '1.4s' }}>
                    <div className="w-5 h-5 sm:w-6 sm:h-6 bg-[#023F33] rounded-full flex items-center justify-center flex-shrink-0">
                      <svg className="w-3 h-3 sm:w-4 sm:h-4 text-white" fill="currentColor" viewBox="0 0 20 20">
                        <path fillRule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clipRule="evenodd" />
                      </svg>
                    ...
                    <div>
                      <h4 className="font-semibold text-[#023F33] mb-1 text-sm sm:text-base" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>Mentorship</h4>
                      <p className="text-xs sm:text-sm text-gray-600">Guiding next generation leaders</p>
                    </div>
                  </div>
                </div>
              </div>
