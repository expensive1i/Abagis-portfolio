        ...
        <div className="max-w-7xl mx-auto px-6 py-12">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-8">
            ...
            <div className="text-center lg:text-left">
              <h3 className="text-2xl font-bold mb-4" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>Lucy James Abagi</h3>
              <p className="text-white/80 mb-4 max-w-md text-sm leading-relaxed">
