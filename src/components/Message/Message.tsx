  ...
  return (
    <section ref={sectionRef} className="py-16 px-4">
      <div className="max-w-7xl mx-auto relative ">
        ...
        <div className={`bg-[#023F33] p-6 relative  z-10 mt-16 border-4 border-white/20 rounded-3xl transition-all duration-1000 ease-out ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`} style={{ transitionDelay: '0.2s' }}>
          <div className="text-white max-w-2xl text-justify">
            <h2 className="text-xl lg:text-2xl font-bold mb-6 leading-tight" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
            A Message from Lucy James Abagi, CEO of the Public and Private Development Centre (PPDC)
            </h2>
            
            {/* First Part */}
            <div className="space-y-3 text-sm leading-relaxed mb-8" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
              <p>
            ...
            {/* Second Part */}
            <div className="space-y-3 text-sm leading-relaxed" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
              <p>
              ...
              <p className="font-semibold text-base" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
        ...
        {/* Image Section - Overlapping the Green Cards - NO ANIMATION */}
        <div className="absolute top-2/5 right-0 transform -translate-y-1/2 z-20">
          <div className="relative">
            <img
              src="/images/heroimgnobg.png"
              alt="Lucy James Abagi, CEO"
              className="w-[500px] h-[600px] object-cover obeject-fit"
            />
            {/* Decorative Elements */}
            <div className="absolute -top-2 -right-2 w-6 h-6 bg-[#FFE066] rounded-full"></div>
            <div className="absolute -bottom-2 -left-2 w-4 h-4 bg-[#FFE066] rounded-full"></div>
          </div>
        </div>
      </div>
    </section>
